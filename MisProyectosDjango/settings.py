...
SECRET_KEY = 'django-insecure-u$nrfcd*v#yw-620@^ql33087u)$w-(uf0t$eh%5k%ruqd^y8_'
...
ROOT_URLCONF = 'MisProyectosDjango.urls'
...
WSGI_APPLICATION = 'MisProyectosDjango.wsgi.application'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'miappGraficacion/static')]
